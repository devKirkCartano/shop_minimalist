    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active icon-color" href="salesInventory.php"><svg
                            ...
                            </svg><span>Sales</span></a><a class="nav-link icon-color" href="inventory.php"><i
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <form action="editActionSales.php" method="post"><!-- Start: 1 Row 3 Columns -->
                    <div class="container">
                        <div class="row" style="margin-top: 50px;">
                            <div class="col-md-4">
                                <input class="form-control" type="text" name="customer-name"  
                                    placeholder="Customer Name" value="<?php echo $customer_name ?>" required>
                            </div>
                            <div class="col-md-4">
                              <input class="form-control "type="date" name="date" value="<?php echo $date ?>" min="2022-01-01" max="2023-7-31">
                            </div>
                            <div class="col-md-4">
                                  <select class="form-select" name="shipment" required>
                                    <option value="<?php echo $shipment ?>"  selected><?php echo $shipment ?></option>
                    ...
                    <div class="container">
                        <div class="row" style="margin-top: 50px;" >
                            ...
                            <div class="col-md-4" >
                                <input class="form-control" type="number" value="<?php echo $quantity ?>" id="quantity" name="quantity" oninput="calculateTotal(this.value)"  min="1" max="100"
                                    placeholder="Quantity" required>
                            </div>
                            <div class="col-md-4">
                                <input class="form-control" type="number" value="<?php echo $amount ?>" id="amount" name="amount" oninput="calculateTotal(this.value)"  min="1" step="0.01" placeholder="Amount of Item" required>
                                </div>
                                <div class="col-md-4">
                                    <input class="form-control" type="number" value="<?php echo $total ?>" disabled id="total" name="total" placeholder="Total" readonly>
                                    </div>
                            ...
                            <input class="btn btn-primary btn-save title-page-text" type="submit" name="update-sales-btn"
                                style="position: relative;display: flex;" value="Update Sales">
                        </div>
                    </form>
                </div>
