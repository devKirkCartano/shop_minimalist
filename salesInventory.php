...
$usersql = "SELECT * FROM users WHERE email = '" . $_SESSION['email'] . "'"; // query to select the user who logged in
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h3 class="text-dark mb-4 title-page-text">Sales Inventory</h3>
                    
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4" id="table-bg">
                        <div class="card-header py-3" id="table-header">
                            <h6 class="m-0 font-weight-bold text-primary card-text">Sales</h6>
                        </div>
                        <div class="card-body card-text">
                            <div class="table-responsive">
                            <a href="addSales.php"><input class="btn btn-primary btn-save title-page-text" type="submit" name="submit-btn" value="Add Sales"
