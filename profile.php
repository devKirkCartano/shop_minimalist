...
if (isset($_SESSION['fname']) && isset($_SESSION['lname']) && isset($_SESSION['email'])) {
	...
	<head>
		...
		<title>Profile - Shop Minimalist</title>
		...
		<div id="wrapper">
			<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
				...
				<div class="container-fluid d-flex flex-column p-0"><a
						class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="index.php"><img
							id="logo" class="border rounded-circle" src="assets/img/imported_images/logo-circle.png" />
						<div class="sidebar-brand-icon rotate-n-15"></div>
						<div class="sidebar-brand-text mx-3"><span class="fs-6 brand-name icon-color brand-name-text">Shop Minimalist
								<br />Admin</span></div>
					</a>
					...
					<ul class="navbar-nav text-light" id="accordionSidebar">
						...
						<li class="nav-item"><a class="nav-link icon-color" href="salesInventory.php"><svg xmlns="http://www.w3.org/2000/svg"
									enable-background="new 0 0 24 24" height="1em" viewBox="0 0 24 24" width="1em" fill="currentColor"
									class="icon-color">
								...
								</svg><span>Sales Inventory</span></a></li>
						<li class="nav-item"><a class="nav-link icon-color" href="inventory.php"><i
									class="far fa-list-alt icon-color"></i><span>Product Inventory</span></a></li>
			...
			<div class="d-flex flex-column" id="content-wrapper">
				<div id="content">
					<nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
						<div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop"
							...
							<form class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search">
								<div class="input-group"><input class="bg-light form-control border-0 small" type="text" id="search-bar"
										placeholder="Search for ..."><button class="btn btn-primary py-0 icon-color" id="btn-search"
									...
									<div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false"
										...
										<div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
											<h6 class="dropdown-header card-text">alerts center</h6><a
												...
												<div class="fw-bold">
													<div class="text-truncate"><span>Am I a good boy? The reason I ask is because someone told me
															that people say this to all dogs, even if they aren't good...</span></div>
					...
					<div class="container-fluid">
						<h3 class="text-dark mb-4 title-page-text">Profile</h3>
						<div class="row mb-3">
							<div class="col-lg-4">
								<div class="card mb-3">
									<div class="card-body text-center shadow bg-white"><img class="rounded-circle mb-3 mt-4"
											src="assets/img/imported_images/female_profile.svg" width="160" height="160">
										<div class="mb-3"><button class="btn btn-primary btn-sm btn-save card-text" type="button">Change
												Photo</button></div>
									</div>
								</div>
								<div class="card shadow mb-4">
									<div class="card-header py-3 bg-white">
										<h6 class="text-primary fw-bold m-0 card-text">Projects</h6>
									</div>
									<div class="card-body bg-white">
										<h4 class="small fw-bold card-text">Server migration<span class="float-end">20%</span></h4>
										...
										<h4 class="small fw-bold card-text">Sales tracking<span class="float-end">40%</span></h4>
										<div class="progress progress-sm mb-3">
										...
										<h4 class="small fw-bold card-text">Customer Database<span class="float-end">60%</span></h4>
										<div class="progress progress-sm mb-3">
										...
										<h4 class="small fw-bold card-text">Payout Details<span class="float-end">80%</span></h4>
										<div class="progress progress-sm mb-3">
										...
										<h4 class="small fw-bold card-text">Account setup<span class="float-end">Complete!</span></h4>
										<div class="progress progress-sm mb-3">
						...
						<div class="card shadow mb-5">
							<div class="card-header py-3 bg-white">
								<p class="text-primary m-0 fw-bold card-text">Forum Settings</p>
							</div>
							<div class="card-body bg-white">
								<div class="row">
									<div class="col-md-6">
										<form>
											<div class="mb-3"><label class="form-label card-text"
													...
													id="signature" rows="4" name="signature"></textarea></div>
											<div class="mb-3">
												<div class="form-check form-switch"><input class="form-check-input" type="checkbox"
														id="formCheck-1"><label class="form-check-label card-text" for="formCheck-1"><strong>Notify me
				...
				<footer class="bg-white sticky-footer">
					<div class="text-center my-auto copyright"><span class="copyright-text"><a
								href="https://www.instagram.com/_shopminimalist/" target="_blank"><svg class="bi bi-instagram socmed-icon"
									...
									class="bi bi-facebook socmed-icon" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
